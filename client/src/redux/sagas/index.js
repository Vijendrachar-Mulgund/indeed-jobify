...
import { userLogin, userSignUp, userAutoAuth, userLogOut, userGoogleLogin } from "../slices/userSlice";
import {
  handleUserLogin,
  handleUserSignUp,
  handleAutoAuthenticate,
  handleGoogleUserLoginAction,
  handleLogOut,
} from "./handlers/userHandler";

export default function* rootSagas() {
  yield all([takeLatest(userLogin.type, handleUserLogin)]);
  yield all([takeLatest(userGoogleLogin, handleGoogleUserLoginAction)]);
